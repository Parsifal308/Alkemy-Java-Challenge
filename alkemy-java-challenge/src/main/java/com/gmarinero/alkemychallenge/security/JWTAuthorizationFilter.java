package com.gmarinero.alkemychallenge.security;
...
public class JWTAuthorizationFilter extends OncePerRequestFilter{
	...
	//añade configuracion necesaria para autorizar la peticion
